...
SimpleSwiper.prototype.pointColorChang = function(color){
    
    this.$pagination.css('width',color)
    this.$pagination.css('hieght',color)   
    // console.log(color) 
}

SimpleSwiper.prototype.pointSizeChang = function(size){
    this.$pagination.css('size',size+'px')
